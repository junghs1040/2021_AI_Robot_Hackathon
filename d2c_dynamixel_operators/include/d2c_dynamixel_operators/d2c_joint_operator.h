...
class JointOperator
{
 ...
 public:
  ...
  void moveCommandMsgCallback(const d2c_robot_msgs::DynamixelCommand::ConstPtr& msg);
  std::vector<std::string> motionNameChoice();
  std::vector<std::vector<double>> motionChoice();
  std::vector<double> timeChoice();
};
